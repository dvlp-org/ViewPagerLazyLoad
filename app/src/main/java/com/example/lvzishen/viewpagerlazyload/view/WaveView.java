 ...
 */
package com.example.lvzishen.viewpagerlazyload.view;
...
public class WaveView extends View {
    ...
    public static final int DEFAULT_BEHIND_WAVE_COLOR = Color.parseColor("#DEBB89");
    public static final int DEFAULT_FRONT_WAVE_COLOR = Color.parseColor("#E4C9A1");
    ...
    //背景颜色
    private LinearGradient mWaveShaderb;
    // shader matrix
    private Matrix mShaderMatrix;
    // paint to draw wave
    private Paint mViewPaint;
    private Paint mViewPaintb;
    ...
    private void init() {
        ...
        //背景
        mViewPaintb = new Paint();
        mViewPaintb.setAntiAlias(true);
    ...
    private void createShader() {
        ...
        mWaveShaderb=new LinearGradient(0,0,getWidth(),getHeight(), Color.parseColor("#c7a975"), Color.parseColor("#c7a975"), Shader.TileMode.CLAMP);

        mViewPaintb.setShader(mWaveShaderb);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mShowWave && mWaveShader != null) {
            ...
            mWaveShaderb.setLocalMatrix(mShaderMatrix);
            ...
            switch (mShapeType) {
                case CIRCLE:
                    ...
                    float radius2 = getWidth() / 2f - borderWidth;
                    canvas.drawCircle(getWidth() / 2f, getHeight() / 2f, radius2, mViewPaintb);
                ...
                case SQUARE:
                    ...
                    canvas.drawRect(borderWidth, borderWidth, getWidth() - borderWidth,
                            getHeight() - borderWidth, mViewPaintb);
